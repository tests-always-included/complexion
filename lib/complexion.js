 ...
 *     tokenizer = new Complexion(MySpecialToken);
 *
...
(function (n, r, f) {
     ...
     * constructor here as `tokenClass`.  See this file's doc block for
     * further information.
     *
     * @param {Object} TokenClass Object constructor to use for new tokens
     */
    function Complexion(TokenClass) {
        if (!(this instanceof Complexion)) {
            return new Complexion(TokenClass);
        }
    ...
    /**
     * Helper functions that are attached to the main object.  They provide
     * often used matching functions.
     */
     ...
     * @return {Complexion~matcher}
     */
    Complexion.matchString = function (strToMatch, nextMatcher) {
        var matchLength;
     ...
     *
     * @see Complexion.matchString
     * @param {string} strToMatch What to match
     * @param {Complexion~matcher} nextMatcher
     * @return {Complexion~matcher}
     */
    Complexion.matchStringInsensitive = function (strToMatch, nextMatcher) {
    ...
    Complexion.prototype.tokenize = function (parseStr) {
        var i, c, col, cr, lf, line, matchedContent, matchedContentLen, matchers, matchersLen, offset, parseLen, token, TokenClass, tokenList, types;
        ...
        function getToken() {
            for (i = 0; i < matchersLen; i += 1) {
                matchedContent = matchers[i](parseStr, offset);
