...
(function (n, r, f) {
    ...
    /**
     * Callback for initializing Complexion with a plugin
     *
     * @callback Complexion~plugin
     * @param {Complexion} this
     */

    /**
     * Initialize the tokenizer with a given set of matchers provided by
     * a Complexion plugin.
     *
     * @param {Complexion~plugin} plugin
     */
    Complexion.prototype.addPlugin = function (plugin) {
        plugin(this);
    };
